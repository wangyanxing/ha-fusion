...
/**
 * Auto-discovers UniFi Protect related sensors from the same camera device.
 * UniFi Protect exposes multiple entities per camera with a consistent naming
 * pattern: camera.<name> → binary_sensor.<name>_motion/_doorbell, sensor.<name>_event.
 */
